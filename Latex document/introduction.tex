...
A time-spatial image reflects the state of a fixed line changes with time, thus if a vehicle crosses or touches the VDL, it appears on the TSI, thus becomes detectable\ref{fig:TSI}.
