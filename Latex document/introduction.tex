...
An approach similar to the aforementioned was first introduced in 2001 by Albiol et. al., and was proposed for counting people on video sequences using "stack of lines" -- equivalent to a TSI\cite{Albiol2001}.
...
In 2013 Yang et. al. discussed a new approach for time-spatial imagery extraction.
...
%The TSI-based method is still popular, and in the recent years several 
...
Note that in this study TSIs are used solely for classification purposes, the detection takes place on the original images.
...
TSIs are still widely popular to this day
...
If no object moves in the detect region, there is no
gray changed. Otherwise, gray will be changed by
moving objects
...
The thesis also focuses on the results of the performance tests and software experiments, and further improvement propositions.
