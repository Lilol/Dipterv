...
\begin{figure}
	...
	\end{subfigure}
	\caption{Camera placement (left) and a typical frame scene of the Traffic Sensor (right). The camera's optical axis is vertical. For testing a panoramic camera with a wide angle of view was used, so the entire width of the road can be monitored.}
