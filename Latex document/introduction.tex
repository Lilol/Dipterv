...
One level up dynamic parameters are measured and the position of vehicles is approximated using various tracking algorithms. 
The main purposes of tracking vehicles across frames is to estimate  motion and predict vehicle position in the image, enforcing temporal coherence and omitting false positives in counting.
...
Although handling extreme weather or light conditions, like heavy rain, fog, night-time or shadows is still challenging for visual sensors, a series of different solutions has been proposed to solve these problems.
