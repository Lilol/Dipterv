...
The result of the detection is exported as a text file, and sent through the EnTalk Network to transfer to the backend.
...
The system is possible to build and save video files too for demonstration purposes. 
%----------------------------------------------------------------------------
\subsection{Operation modes of the Traffic Sensor}\label{chap:operation_modes}
%----------------------------------------------------------------------------
