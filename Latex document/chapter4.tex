...
Other irregular, időnkénti! control and management functions are handled by the Project Configurator application, and are detailed in the following section.
...
Firstly, they refer to instances of the described cases, and secondly, in equations, they mean the number of cases found whilst evaluating a specific test video.
