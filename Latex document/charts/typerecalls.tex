\pgfplotstableread[
	...
	columns/Code/.style={string type}]{csvs/typerecalls.csv}\typerecalls
...
%			every node near coord/.append style={/pgf/number format/.cd, fixed, precision=0},
		...
		\addplot table[x=1stversion, y=Code]{\typerecalls};
		\addplot table[x=2ndversion, y=Code]{\typerecalls};
		\addplot table[x=3rdversion, y=Code]{\typerecalls};
		\addplot table[x=4thversion, y=Code]{\typerecalls};
		\addplot table[x=5thversion, y=Code]{\typerecalls};
