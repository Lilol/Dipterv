...
The sizes on the Size Timeline are converted to metrics with a scaling-factor that is specified in the configuration files, and depends on the particular traffic scene and frame setting.
